...
dataset_path = os.path.join('datos', 'rps_dataset.npy')
labels_path = os.path.join('datos', 'rps_labels.npy')
...
rock_emoji = cv2.imread(r'C:\Users\src4\Documents\GitHub\AA2-Menescaldi-Britos\Ejercicio 2\emojis\rock.png', cv2.IMREAD_UNCHANGED)  # Includes alpha channel
scissors_emoji = cv2.imread(r'C:\Users\src4\Documents\GitHub\AA2-Menescaldi-Britos\Ejercicio 2\emojis\scissors.png', cv2.IMREAD_UNCHANGED)  # Includes alpha channel
paper_emoji = cv2.imread(r'C:\Users\src4\Documents\GitHub\AA2-Menescaldi-Britos\Ejercicio 2\emojis\paper.png', cv2.IMREAD_UNCHANGED)  # Includes alpha channel
